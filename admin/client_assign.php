...
<?php
    ...
    $booking_detail =  Booking::find_by_booking_id($booking_id);
     ...
     foreach ($categories as $category) {
        if ($category->id == $booking_detail->wedding_type) {
    ...
    if (isset($_POST['confirm'])) {
        ...
        if ($booking_detail) {
            ...
            $liquidate->credit = $price - $cash_advanced ;
            $liquidate->date_modified = date('Y-m-d H:i:s');
            $liquidate->save_liquidation();
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="input-group col-md-6">
                            ...
                            <input type="text" class="form-control"
                                   name="wedding_date" value="<?= $booking_detail->wedding_date; ?>" id="wedding_date"
